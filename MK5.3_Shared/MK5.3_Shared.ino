// Relay information on Line 39, and Lines 282-285
...
const char *GScriptId = "xxxxxxxxxxxxx";   //ENTER_Deployment ID
String gate_number = "Gate1";   //Enter gate number/cubby ID
//---------------------------------------------------------------------------------------------------------
// Enter network credentials:
const char* ssid     = "xxxxxxxxxxx";   // ENTER_WIFI_SSID
const char* password = "xxxxxxxxxxx";   //ENTER_WIFI_PASS
//---------------------------------------------------------------------------------------------------------
// Enter command (insert_row or append_row) and your Google Sheets sheet name (default is Sheet1):
String payload_base =  "{\"command\": \"insert_row\", \"sheet_name\": \"IC Attendance Log\", \"values\": ";
String payload = "";
//---------------------------------------------------------------------------------------------------------
...
#define SS_PIN   2  //D4
#define BUZZER   4  //D2
#define RELAY    16 //D0                                                          //Edit, add relay
//------------------------------------------------------------
...
//ADD RELAY CONTROL HERE?????      *********************************************                                       Edit, add relay
